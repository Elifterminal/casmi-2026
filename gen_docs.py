...
def build_chat(m, W):
    ...
    p.append('<div class="compose"><h3>Leave a comment</h3>'
             ...
             '<div class="crow">'
             '<label>From <select id="cfrom"><option>seda</option><option>vanta</option>'
             '<option>alex</option><option>gpt</option><option>lee</option></select></label>'
             '<label>To <select id="cto"><option>elif</option><option>all</option>'
             '<option>seda</option><option>vanta</option><option>alex</option>'
             '<option>gpt</option><option>lee</option></select></label>'
             '</div>'
             '<form id="cform">'
